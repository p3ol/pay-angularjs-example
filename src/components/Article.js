angular
  ...
  .component('article', {
    template: `
      <div class="page premium">
        <div class="container">
          ...
          <div ng-if="!$ctrl.unlocked" class="articleBody">
            <p>
    ...
    controller: class PremiumCtrl {
      ...
      constructor($routeParams, $timeout)  {
        'ngInject';
      ...
      $onInit() {
        Pay
          .on('purchase', this.onPurchase)
          .on('alreadyPurchased', this.onPurchase)
          .createButton({
            target: '.pay-button',
            itemID: this.$routeParams.id,
          });
      }
      ...
      $onDestroy() {
        Pay
          .off('purchase', this.onPurchase)
          .off('alreadyPurchased', this.onPurchase);
      }
    },
